...
export const CreateEvent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        for (const key in form) {
            if (form[key] !== null && form[key] !== undefined && form[key] !== "") {
                if (key === 'EventImage' && form[key] instanceof File) {
                    formData.append(key, form[key]);
                } else if (key === 'IsActive') {
                    formData.append(key, form[key] ? 1 : 0);
                } else if (key === 'EventTypeId' || key === 'VenueId' || key === 'OrganizerId' || key === 'EventStatus' || key === 'TotalTicketQuantity') {
                    formData.append(key, form[key] ? parseInt(form[key]) : '');
                } else {
                    formData.append(key, form[key]);
                }
            }
    ...
    const handleOnChange = (e) => {
        ...
        if (name === "EventImage") {
            setForm((prev) => ({ ...prev, EventImage: files[0] || null }));
            ...
            <div className="mt-6 border border-gray-200 shadow-xl rounded-2xl overflow-hidden bg-white p-6 md:p-8 max-w-5xl mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 pb-6 border-b border-gray-100">
                    <div className="mb-4 sm:mb-0">
                        ...
                        <p className="text-gray-500 mt-2">Add a new event with ticket types</p>
                    </div>
                    <Link
                        to="/admin/events"
                                        ...
                                        <div className="relative">
                                            {form.EventImage ? (
                                                <div className="w-64 h-48 rounded-xl border-4 border-purple-200 overflow-hidden shadow-md">
                                                    <img
                                                        src={typeof form.EventImage === 'string'
                                                            ? form.EventImage
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl p-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pb-4 border-b border-gray-100">
                            <div>
                                ...
                                <p className="text-gray-500 mt-2">Define different ticket types for your event</p>
                            </div>
                            <button
                                type="button"
